...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT 'crm_customer loaded | Rows: ' + CAST(@rowcount AS VARCHAR) 
              + ' | Time: ' + CAST(@duration AS VARCHAR) + ' sec';
        ...
        PRINT 'crm_prd_info loaded | Rows: ' + CAST(@rowcount AS VARCHAR) 
              + ' | Time: ' + CAST(@duration AS VARCHAR) + ' sec';
        ...
        PRINT 'crm_sales_details loaded | Rows: ' + CAST(@rowcount AS VARCHAR) 
              + ' | Time: ' + CAST(@duration AS VARCHAR) + ' sec';
        ...
        PRINT 'erp_cust_az12 loaded | Rows: ' + CAST(@rowcount AS VARCHAR) 
              + ' | Time: ' + CAST(@duration AS VARCHAR) + ' sec';
        ...
        PRINT 'erp_loc_a101 loaded | Rows: ' + CAST(@rowcount AS VARCHAR) 
              + ' | Time: ' + CAST(@duration AS VARCHAR) + ' sec';
        ...
        PRINT 'erp_px_cat_g1v2 loaded | Rows: ' + CAST(@rowcount AS VARCHAR) 
              + ' | Time: ' + CAST(@duration AS VARCHAR) + ' sec';
